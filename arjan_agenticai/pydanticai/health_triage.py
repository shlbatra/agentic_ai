...
##################################################################
### Define Schema for agent depedencies and output
##################################################################
...
##################################################################
### Build Agent with system prompt and tool use
##################################################################
...
# Add tool use for more context by calling a method ex. get latest vitals as a database request (augment patient info)
@triage_agent.tool
